...
dfout = TFile( "WHSS_histogram.root" , "recreate" )
...
def PrepareVariable( df_in , name ):
    ...
    # Define
    df_in = df_in.Define( 'Lepton1_eta' , 'Lepton_eta[0]' ).Define( 'Lepton2_eta' , 'Lepton_eta[1]' ).Define( 'Lepton1_pt' , 'Lepton_pt[0]' ).Define( 'Lepton2_pt' , 'Lepton_pt[1]' )
